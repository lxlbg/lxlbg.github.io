           ...
           // childElement.eq(ex).addClass("cur");
            ...
            if(isRun){
				if(allTime<=0){ //积分已经用完了
				   $.DialogByZ.Alert({Title: "提示", Content: "您的次数已经用完啦！",BtnL:"知道了"});	
			     }
                return;
            }else{
                //重新生成序列
